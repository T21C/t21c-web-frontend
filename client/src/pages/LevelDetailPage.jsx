...
import { fetchLevelInfo, getYouTubeEmbedUrl, getYouTubeThumbnailUrl } from "../Repository/RemoteRepository";
  ...
  return (
    <div className="level-detail">
      ...
      <div className="wrapper-level wrapper-level-top">
        ...
        <div className="left" style={{ backgroundImage: `url(${res.level ? getYouTubeThumbnailUrl(res.level.vidLink, res.level.title) : 'defaultImageURL'})` }}>
            <div className="diff">
              <p>20</p>
            </div>
            ...
            <div className="title">
              ...
              <p>#{id}&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;{res.level.song}&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;{res.level.artist}</p>
            </div>
          </div>
        ...
        <div className="info">
          <div className="info-item">
            <p>First Clear</p>
            <span className="info-desc">{res.passes.count ? res.passes.results[0].player : "-"}</span>
          </div>
          <div className="info-item">
            <p>Highest Score</p>
            <span className="info-desc">adrian</span>
          </div>
          <div className="info-item">
          ...
          <div className="info-item">
            ...
            <span className="info-desc">{res.passes.count ? res.passes.count : "0"}</span>
          </div>
        ...
        <div className="rank">
          ...
          <div className="rank-list">
            {res.passes.count ? (
              res.passes.results.map((each, index) => (
