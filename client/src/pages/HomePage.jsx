...
const HomePage = () => {
  ...
  useEffect(()=>{
    const fetchData = async () => {
      ...
      const lastRow = [
        [data.results[data.results.length-1].creator, data.results[data.results.length-1].song, data.results[data.results.length-1].artist, data.results[data.results.length-1].vidLink.slice(32)],
        [data.results[data.results.length-2].creator, data.results[data.results.length-2].song, data.results[data.results.length-2].artist, data.results[data.results.length-2].vidLink.slice(32)],
        [data.results[data.results.length-3].creator, data.results[data.results.length-3].song, data.results[data.results.length-3].artist, data.results[data.results.length-3].vidLink.slice(32)]
      ]
  ...
  return (
    ...
    <div className="home">
      ...
      <div className='hero-text'>
        <h1> <span>21</span> Forums</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae tenetur cumque deserunt eligendi aperiam in, nisi quibusdam ad iure sint molestias voluptate eos aliquid ab nulla soluta. Temporibus provident neque, officiis numquam quo quae asperiores!</p>
