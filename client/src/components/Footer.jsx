    ...
    <footer>
        <div className="wrapper">
            ...
            <div className='about-container'>
                <h2>About Us</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique sint pariatur veniam nostrum cumque, tempora deleniti necessitatibus, voluptatum praesentium laudantium neque, dignissimos quasi natus officia.</p>
            </div>
        ...
        <p className='copy-right'>&copy; 2024 Adrian Purnama. All rights reserved.</p>
