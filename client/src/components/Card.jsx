    ...
    >
      ...
      >
        ...
        <div 
          ...
          style={{ width: '100%', transition: 'transform 0.2s ease', transformStyle: 'preserve-3d' }}
        > 
          <img src={`https://img.youtube.com/vi/${image}/sddefault.jpg`} alt="Song Thumbnail" style={{ width: '100%' }} />
        </div>
