...
const PlayerCard = ({key, player, rankedScore, generalScore, avgXacc, totalPasses, universalPasses, WFPasses, topDiff, latestClears}) => {
  console.log("got data", key, player, rankedScore, generalScore, avgXacc, totalPasses, universalPasses, WFPasses, topDiff, latestClears);
