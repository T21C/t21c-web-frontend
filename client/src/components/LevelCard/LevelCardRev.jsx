...
const LevelCardRev = ({index, level, legacyMode }) => {
  ...
  const lvImage = 
  legacyMode ?
  getLevelImage(level.newDiff, level.pdnDiff, null, level.diff)
  :
  getLevelImage(level.newDiff, level.pdnDiff, level.pguDiff, level.diff)
  ...
  return (
    <div className='level-card-rev' onClick={() => redirect()}>
      ...
      <div className="downloads-wrapper">
        {level.ws &&
            <a href={level.ws} onClick={onAnchorClick} target="_blank">
          ...
          {level.dl &&             
          <a href={level.dl} onClick={onAnchorClick} target="_blank">
