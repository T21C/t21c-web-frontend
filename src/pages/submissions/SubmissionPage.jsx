    ...
    <div className="submission-page">
      ...
      {hasFlag(user, permissionFlags.SUBMISSIONS_PAUSED) ? (
        ...
        <div className="submission-passes wrapper-body wrapper-top">
          ...
          <button className="submit-button btn-fill-primary alt" onClick={handleSubmitPassClick}>
        ...
        <div className="submission-level wrapper-body wrapper-top">
          ...
          <button className="submit-button btn-fill-primary alt" onClick={handleSubmitLevelClick}>
