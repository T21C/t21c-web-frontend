      ...
      {hasFlag(user, permissionFlags.SUBMISSIONS_PAUSED) ? (
        ...
        <div className="email-not-verified banner">
          ...
          <span className="verify-email">
            <button className="button tuf-btn-fill-primary" onClick={() => navigate('/profile/verify-email')}>{t('submission.banner.verifyEmail')}</button>
          </span>
        </div>
      ) : (
        <>
        <div className="submission-passes wrapper-body wrapper-top">
          <h2>{t('submission.header.headerPass')}</h2>
          ...
          <button className="submit-button tuf-btn-fill-primary alt" onClick={handleSubmitPassClick}>
            {t('submission.button.buttonPass')}
          </button>
        </div>

        <div className="submission-level wrapper-body wrapper-top">
          <h2>{t('submission.header.headerLevel')}</h2>
          ...
          <button className="submit-button tuf-btn-fill-primary alt" onClick={handleSubmitLevelClick}>
            {t('submission.button.buttonLevel')}
          </button>
        </div>
        </>
      )}
