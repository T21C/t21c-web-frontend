        ...
        <div className="about-us-container page-content-70rem">
          <div className="about-content">
            ...
            <section className="about-section">
              ...
              <p>{t('about.sections.mission.intro')}</p>
              <ul>
                {t('about.sections.mission.points', { returnObjects: true }).map((point, index) => (
            ...
            <section className="about-section">
              <h2>{t('about.sections.values.title')}</h2>
              <div className="values-grid">
                {Object.entries(t('about.sections.values.cards', { returnObjects: true })).map(([key, value]) => (
            ...
            <section className="about-section">
              <h2>{t('about.sections.join.title')}</h2>
              <div className="community-links">
                <ExternalLink href="https://discord.gg/adofai" className="community-link discord">
                  ...
                  {t('about.sections.join.links.discord')}
                </ExternalLink>
                <ExternalLink href="https://github.com/T21C" className="community-link github">
                  ...
                  {t('about.sections.join.links.github')}
                </ExternalLink>
              </div>
            </section>
              ...
              <div className="section-content">
                ...
                <div className="version-info" style={{
                  ...
                  <div className="main-title">
                    <span className="title-mask">{t('about.sections.credits.version', { version: CURRENT_VERSION })}</span>
                    <span className="title-glow">{t('about.sections.credits.version', { version: CURRENT_VERSION })}</span>
                  </div>
                </div>
                <div className="credits-grid">
                  <div className="credit-category">
                    <h3>{t('about.sections.credits.categories.rating.title')}</h3>
                        ...
                        <div key={rater.discordId} className="credit-item">
                          ...
                          <div className="rater-info">
                            ...
                            <span className="credit-role">
                              {t('about.sections.credits.categories.rating.roles.' + (hasFlag(rater, permissionFlags.SUPER_ADMIN) ? 'manager' : 'rater'))}
                            </span>
                          </div>
                        </div>
                      ))}
