...
const SettingsSecurityPage = lazy(() => import('./account/settings/SettingsSecurityPage'));
...
const ResourcesClusterDetailPage = lazy(() => import('./misc/ResourcesPage/ResourcesClusterDetailPage'));
