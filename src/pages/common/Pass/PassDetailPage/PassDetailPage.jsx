        ...
        <div className="pass-content">
          ...
          <div className="pass-actions">
            {user && user.playerId === pass.player?.id && (
              <button 
                className={`hide-button tuf-btn-fill-glass ${pass.isHidden ? 'hidden' : ''}`}
            ...
            {hasFlag(user, permissionFlags.SUPER_ADMIN) && (
              <button className="edit-button tuf-btn-fill-accent" onClick={() => setOpenEditDialog(true)}>
          ...
          <div className="hide-confirm-overlay" onClick={() => setShowHideConfirm(false)}>
            <div className="hide-confirm-dialog" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="hide-confirm-actions">
                <button className="confirm-button tuf-btn-fill-primary" onClick={handleToggleHidden} disabled={isTogglingHidden}>
                  {isTogglingHidden 
                ...
                <button className="cancel-button tuf-btn-fill-neutral-dark" onClick={() => setShowHideConfirm(false)} disabled={isTogglingHidden}>
