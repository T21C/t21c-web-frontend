...
export const routes = {
  auth: {
    ...
    oauthLogin: (provider) => `/v2/auth/login/${enc(provider)}`,
    oauthLink: (provider) => `/v2/auth/oauth/link/${enc(provider)}`,
    oauthCallback: () => '/v2/auth/oauth/callback',
  ...
  admin: {
    ...
    statisticsRatingAccuracy: () => '/v2/admin/statistics/rating-accuracy',
    ...
    keyboards: () => '/v2/admin/keyboards',
    keyboardImportKle: () => '/v2/admin/keyboards/geometries/import-kle',
    keyboardGeometryImportKle: (id) => `/v2/admin/keyboards/geometries/${enc(id)}/import-kle`,
    keyboardGeometry: (id) => `/v2/admin/keyboards/geometries/${enc(id)}`,
    keyboardProducts: () => '/v2/admin/keyboards/products',
    keyboardProduct: (id) => `/v2/admin/keyboards/products/${enc(id)}`,
    keyboardSwitches: () => '/v2/admin/keyboards/switches',
    keyboardSwitch: (id) => `/v2/admin/keyboards/switches/${enc(id)}`,
    keyboardFormFactors: () => '/v2/admin/keyboards/form-factors',
    keyboardFormFactorOrder: () => '/v2/admin/keyboards/form-factors/reorder',
    keyboardFormFactor: (slug) => `/v2/admin/keyboards/form-factors/${enc(slug)}`,
    ...
    usefulLinks: {
      ...
      groupSortOrders: () => '/v2/admin/useful-links/groups/sort-orders',
      groupAssignments: () => '/v2/admin/useful-links/group-assignments',
  ...
  database: {
    ...
    difficulties: {
      ...
      tagGroups: () => '/v2/database/difficulties/tags/groups',
      tagGroup: (groupId) => `/v2/database/difficulties/tags/groups/${enc(groupId)}`,
  ...
  playersV3: {
    ...
    meProfileModules: () => '/v3/players/me/profile-modules',
    keyboardSetups: (playerId) => `/v3/players/${enc(playerId)}/keyboard-setups`,
    meKeyboardSetups: () => '/v3/players/me/keyboard-setups',
    meKeyboardRigs: () => '/v3/players/me/keyboard-setups/rigs',
    meKeyboardRig: (rigId) => `/v3/players/me/keyboard-setups/rigs/${enc(rigId)}`,
    meKeyboardImport: () => '/v3/players/me/keyboard-setups/rigs/import',
    meKeyboardRevision: (rigId) => `/v3/players/me/keyboard-setups/rigs/${enc(rigId)}/revisions`,
    meKeyboardLane: (laneId) => `/v3/players/me/keyboard-setups/lanes/${enc(laneId)}`,
    mePassKeyboardSetup: (passId) => `/v3/players/me/passes/${enc(passId)}/keyboard-setup`,
    meShowFollowerCount: () => '/v3/players/me/show-follower-count',
  ...
  keyboardsV3: {
    catalog: () => '/v3/keyboards/catalog',
    current: () => '/v3/keyboards/current',
  },
  ...
  creatorsV3: {
    ...
    meProfileModules: () => '/v3/creators/me/profile-modules',
    meShowFollowerCount: () => '/v3/creators/me/show-follower-count',
  ...
  media: {
    ...
    resolveVideoUrl: (url) => `/v2/media/resolve-video-url?url=${enc(url)}`,
