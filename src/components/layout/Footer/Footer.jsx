...
import './footer.css';
import LogoSVG from '@/assets/tuf-logo/logo';
    ...
    <footer>
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ExternalLink className="footer-link" href="https://discord.gg/adofai">
            ...
            {t('home.footer.community.discord')}
          </ExternalLink>
          <ExternalLink className="footer-link" href="https://github.com/T21C">
            ...
            {t('home.footer.community.github')}
          </ExternalLink>
        </div>
      </div>
      <div className="footer-bottom">
        <p>{t('home.footer.copyright.main', { year: new Date().getFullYear() })}</p>
        <p>{t('home.footer.copyright.credit')}</p>
      </div>
    </footer>
  );
};
