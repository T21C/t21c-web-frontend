...
import { formatSpeed, formatScore } from "@/components/miscrename/Utility"
  ...
  return (
    <div className='score-card'>
      ...
      <div className="speed-wrapper">
          <p className="score-exp">{tScore('labels.speed')}</p>
          <div className="score-desc">{formatSpeed(scoreData.speed)}×</div>
      </div>

      <div className="vid-logo-wrapper">
      {scoreData.videoLink && (
                  <a className="svg-fill" href={scoreData.videoLink} target="_blank" title={tScore('tooltips.watchVideo')}>
