...
export const EditPassPopup = ({ pass, onClose, onUpdate }) => {
  const initialFormState = {
    ...
    ePerfect: pass.judgements[2]?.toString() || '',
    perfect: pass.judgements[3]?.toString() || '',
    lPerfect: pass.judgements[4]?.toString() || '',
    tooEarly: pass.judgements[0]?.toString() || '',
    early: pass.judgements[1]?.toString() || '',
    late: pass.judgements[5]?.toString() || '',
