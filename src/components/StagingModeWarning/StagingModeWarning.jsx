  ...
  return (
    <div className={`staging-mode-warning ${className || ''}`}>
      ...
      <div className="warning-content">
        ...
        <p>This page is currently in staging mode. Any changes you make will not be reflected on the live site, please go to <a href="https://tuforums.com">tuforums.com</a> to make changes.</p>
      </div>
    </div>
  );
};
