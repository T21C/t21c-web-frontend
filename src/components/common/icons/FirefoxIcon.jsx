// tuf-search: #FirefoxIcon #firefoxIcon #icons
import React from 'react';

export const FirefoxIcon = ({ color = "#fff", size = 24, ...props }) => {
  return (
<svg {...props} width={size} height={size} viewBox="0 0 48 48" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" fill={color}>
