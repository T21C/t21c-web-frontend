...
export const SettingsIcon = ({ color = "#fff", size = "24px", strokeWidth = "2"}) => {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" fill={color} stroke={color} strokeWidth={strokeWidth}>
