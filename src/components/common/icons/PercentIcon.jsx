// tuf-search: #PercentIcon #percentIcon #icons
export default function PercentIcon({ className = "", size = "24px", ...props }) {
    return (
        <svg {...props} className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
